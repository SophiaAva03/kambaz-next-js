  ...
  return (
    <div id="wd-asynchronous-arrays">
      ...
      <h4>Todos
        ...
        <FaPlusCircle onClick={createNewTodo} className="text-success float-end fs-3 me-2" />
      </h4>
      <ListGroup>
        {todos.map((todo) => (
          <ListGroupItem key={todo.id}>
            ...
            {todo.editing ? (
              <FormControl className="w-50 d-inline" defaultValue={todo.title}
                onKeyDown={(e) => {
            ...
            <FaTrash onClick={() => removeTodo(todo)} className="text-danger float-end me-2 mt-1" id="wd-remove-todo" />
          </ListGroupItem>
        ))}
      </ListGroup>
      <hr />
