...
export default function TOC() {
  ...
  return (
    <Nav variant="pills">
      ...
      <NavItem>
        <NavLink href="https://github.com/SophiaAva03/kambaz-next-js">React Github</NavLink>
      </NavItem>
      <NavItem>
        <NavLink href="https://github.com/SophiaAva03/kambaz-node-server-app">Node Server Github</NavLink>
      </NavItem>
    </Nav>
  );
}
